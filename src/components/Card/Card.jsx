...
export const Card = ({ title, desc, bg , color = 'bg-white', textColor = 'text-white' }) => {
    return (
        <div className="flex-none w-48 h-64 shadow-lg rounded-lg overflow-hidden transform transition-all hover:-translate-y-4 hover:shadow-xl">

            <div 
            className={`w-full h-3/5 ${bg} bg-cover`}>
            </div>
